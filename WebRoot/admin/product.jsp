...
<link rel="stylesheet" type="text/css" href="./css/bootstrap.css">
	...
	<script type="text/javascript">
		$(function() {
			...
			if (flag) {
				window.location.href = "/Tiger/product?cmd=deleteProduct&deleteId="
  ...
  <body>
   ...
   <div id="propertyDiv">
   <div class="breadcrumb"><a href="/Tiger/admin">所有分类</a>&nbsp;&nbsp;/&nbsp;&nbsp;${c.name}&nbsp;&nbsp;/&nbsp;&nbsp;产品管理</div>
     <!-- Table -->
  <table class="table table-striped table-bordered table-hover  table-condensed">
   ...
   <td><img src="./img/productSingle/${imgList[index.count-1]}.jpg" height="40px"></td>
    ...
    <c:if test="${imgList[index.count-1]==''}">
   <td><img src="./img/nofound.png" height="40px"></td>
   </c:if>
   <td>${product.NAME}</td>
   <td>${product.TITLE}</td>
   <td>${product.PRICE}</td>
   ...
   <td><a href="/Tiger/product?cmd=showProductValue&pId=${product.ID}&c=${product.CID}&pName=${product.NAME}"><span class="glyphicon glyphicon-th-list"></span></a></td>
   ...
   <td><a href="javascript:fn1(${product.ID},${currentPage},${product.CID})"><span class="glyphicon glyphicon-trash"></a></td>
   </tr>
   </c:forEach>
  </table>
</div>
