...
<body>
	...
	<c:if test="${sessionScope.CURRENT_USER!=null}" var="isLogin">
	</c:if>
	<%//如果已经登陆了 %>
	<c:if test="${isLogin}" >
			Tiger网欢迎您：
			<%//判断是否已经设置昵称并保存布尔变量到isSetName %>
			<%-- <c:if test="${sessionScope.CURRENT_USER.nickName!=null}" var="isSetName">
			</c:if>--%>			
			<a href="#"> 			
			<%//设置显示的字为红色 %>
			<font color="red">
			...
			<%//如果已经设置了昵称就显示昵称 %>
			<%-- <c:if test="${isSetName}">
				${sessionScope.CURRENT_USER.nickName}
			</c:if> --%>			
			<%-- <%//如果还没设置昵称就显示邮箱 %>
			<c:if test="${!isSetName}">
			...
			<a href="/Tiger/loginout">注销!</a>
	</c:if>
	<%//如果还没登陆 %>
	<c:if test="${!isLogin}">
			Tiger网欢迎您!
			<span class="rl_text"> <a href="Login/login.jsp" rel="nofollow">登录</a> |
			<a href="Login/reg.jsp" rel="nofollow">注册</a></span> 
	</c:if>             
                </div>
                ...
                <a class="a-float-left" href="#">手机Tiger</a> 
            ...
            <div class="top-right">
                ...
                <div data-toggle="arrowdown" id="arrow4" class="user-name">
                    ...
                    <a href="/Tiger/cart?cmd=showCart">购物车</a>
                    <span class="down-icon"></span>
                </div>
    ...
    <div class="top-main">
        ...
        <div class="search-wrapper">
            <div class="search-box">
                ...
                <input id="searchContent" class="search-in" type="text" placeholder=" 搜‘健康椅’试试，办公好选择">     
                <input type="button" class="search-but" value="搜索" onclick="javascript:fn()"> 
    ...
    <div class="content-top">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-info">
                <ul class="side-li">
                <c:forEach items="${clist}" var="c" varStatus="index">
                    <li class="s_${index.count}"><a href="/Tiger/showproduct?cmd=cproduct&cid=${c.id}"><h3>${c.name}<span class="fa fa-angle-right fa-loc"></span></h3></a></li>
                  </c:forEach>
                </ul>
                <!--hidden-li-box-->
                <ul class="hiden-box">
                <c:forEach items="${plist }" var="list" varStatus="index">
                    <li data-hidden="li" id="hiden-${index.count}">
                    <c:forEach items="${list}" var="p" varStatus="pindex">
                        
                        <div class="productShow">
                            <a href="/Tiger/showproduct?cmd=product&pid=${p.ID}">${p.NAME}</a>
                            <span class="right-box"><i class="fa fa-angle-right"></i></span>
                            </div>
                            </c:forEach>
...
<!--                     <li data-hidden="li" id="hiden-4">
        ...
        <div class="right-con">
            <div class="nav">
                <a id="spe-a1" href="#">虎猫</a>
                <a id="spe-a2" href="#">虎猫国际</a>
                <a id="spe-a3" href="#">虎猫超市</a>
            ...
            <div class="show-box">
                ...
                <div class="content">
                    <ul class="imgBox">
                        ...
                        <li><a href="#"><img src="img/3.1.jpg"></a></li>
                        <li><a href="#"><img src="img/4.1.jpg"></a></li>
                        <li><a href="#"><img src="img/5.5.jpg"></a></li>
                    </ul>
               ...
               <a style="float: left" href="#"><img src="img/6.66.jpg" /></a>
                <!--content-down-->
                <div class="content-down">
                    <ul class="imgBox1">
                        <li>
                            
                            <a href="#"><img src="img/01-1.jpg" /></a>
                           
                        </li>
                        <li>
                            
                            <a href="#"><img src="img/02.2.jpg" /></a>
                            <a href="#"><img src="img/03.png" /></a>                        
                            <a href="#"><img src="img/01.2.jpg" /></a>
                             <a href="#"><img src="img/04.png" /></a>
                        </li>
                        <li>
                            <a href="#"><img src="img/01.png" /></a>
                            <a href="#"><img src="img/02.jpg" /></a>
                            <a href="#"><img src="img/04.1.jpg" /></a>
                            <a href="#"><img src="img/03.1.jpg" /></a>
                        </li>
                        <li>
                            <a href="#"><img src="img/01.png" /></a>
                            <a href="#"><img src="img/02.jpg" /></a>
            ...
            <div class="right-sidebar">
                <div class="info-box">
                    ...
                    <div id="box-1" style="display: block" class="hiddenBox">
                        ...
                        <a href="#">Tiger2017:开放多样性</a>
                        <a href="#">舌尖中国二季 虎猫首尝</a>
                        <a href="#">阿里通信自建计费系统</a>
                        <a href="#">来往首届419宇宙节</a>
                    </div>
                ...
                <div class="user-info">
                    <div class="gold-top">
                        ...
                        <div class="inner-user">
                            <h3>Hi: ${CURRENT_USER==null?"亲":""}${CURRENT_USER.USERNAME}</h3>
                ...
                <div class="service">
                    ...
                    <div  class="service-cell service-z">
    ...
    <div class="main">
        <div class="main-left">
            <div class="main-title">
                <h1>万能的Tiger<span class="show-title">下面有14个特色市场等你来逛哦！</span></h1>
            </div>
        ...
        <div class="main-right">
            <div class="time-go">
                <div class="time-cell">
                    <h1><a href="#" class="text_shadow">我收藏的店铺上新</a><span class="now-news">更新<span class="">27</span></span></h1>
                    <div class="inner-show">
                        <a href="#">
                            <img src="img/inner1.1.jpg">
                ...
                <div class="time-cell">
                    ...
                    <div class="inner-show">
                        <a href="#">
                            <img src="img/inner4.jpg">
                        </a>
                        <a href="#">
                            <img src="img/inner5.jpg">
                        </a>
                        <a href="#">
                            <img src="img/inner6.png">
                        </a>
                        <h3><a href="$">更多店铺上新</a><i class="fa fa-angle-right"></i></h3>
                    </div>
                </div>
    ...
    <div class="main-bottom">
        ...
        <div class="single-sale">
            ...
            <p class="gary-text"><span>￥&nbsp;</span><span><del>399.00</del></span>&nbsp;|&nbsp;<span>月消532件</span></p>
        </div>
        <div class="single-sale">
            <a href="#">
                <img src="img/sing2.jpg" />
                <h3>T恤</h3>
            </a>
            <p><span class="orange">￥&nbsp;</span><span class="orange">89.00</span><span class="send-free">包邮</span></p>
            <p class="gary-text"><span>￥&nbsp;</span><span><del>199.00</del></span>&nbsp;|&nbsp;<span>月消343件</span></p>
        </div>
        
        <div class="single-sale">
            <a href="#">
                <img src="img/sing8.jpg" />
                <h3>猛犸象</h3>
            </a>
            <p><span class="orange">￥&nbsp;</span><span class="orange">99.00</span><span class="send-free">包邮</span></p>
            <p class="gary-text"><span>￥&nbsp;</span><span><del>189.00</del></span>&nbsp;|&nbsp;<span>月消853件</span></p>
        </div>
        <div class="single-sale">
            <a href="#">
                <img src="img/sing9.jpg" />
                <h3>外套</h3>
            </a>
            <p><span class="orange">￥&nbsp;</span><span class="orange">229.00</span><span class="send-free">包邮</span></p>
            <p class="gary-text"><span>￥&nbsp;</span><span><del>459.00</del></span>&nbsp;|&nbsp;<span>月消3241件</span></p>
        </div>
        <div class="single-sale">
            <a href="#">
                <img src="img/sing5.jpg" />
                <h3>面罩</h3>
            </a>
            <p><span class="orange">￥&nbsp;</span><span class="orange">139.00</span><span class="send-free">包邮</span></p>
            <p class="gary-text"><span>￥&nbsp;</span><span><del>269.00</del></span>&nbsp;|&nbsp;<span>月消763件</span></p>
        </div>
        <div class="single-sale">
            <a href="#">
                <img src="img/sing6.jpg" />
                <h3>护膝</h3>
            </a>
            <p><span class="orange">￥&nbsp;</span><span class="orange">59.00</span><span class="send-free">包邮</span></p>
            <p class="gary-text"><span>￥&nbsp;</span><span><del>119.00</del></span>&nbsp;|&nbsp;<span>月消2249件</span></p>
        </div>
        <div class="single-sale">
            <a href="#">
                <img src="img/sing7.jpg" />
                <h3>女士T恤</h3>
            </a>
            <p><span class="orange">￥&nbsp;</span><span class="orange">79.00</span><span class="send-free">包邮</span></p>
            <p class="gary-text"><span>￥&nbsp;</span><span><del>159.00</del></span>&nbsp;|&nbsp;<span>月消3432件</span></p>
        </div>
    </div>
    <!--ad-->
    <div class="ad">
    ...
    <div class="help">
        ...
        <div class="help-info">
            <h1><img src="img/help3.png"><span class="help-text">Tiger特色</span></h1>
            <a class="help-a" href="#">Tiger指数</a>
            <a class="help-a" href="#">虎公仔</a>
            <a class="help-a" href="#">手机Tiger</a>
    ...
    <div class="footer">
        <div class="footer-right">
            ...
            <div class="about-tao">
                ...
                <a href="#">网站地图</a>
                <a href="#">法律声明</a>
                <span class="gary-text">&copy; 2017 Tiger.com 版权所有</span>
            </div>
            <p class="gary-text"><span>网络文化经营许可证：文网文[2010]040号</span>|<span>增值电信业务经营许可证：闵B2-20080224-1</span>|<span>信息网络传播视听节目许可证：1109364号</span></p>
            <div class="some-info">
                <img src="img/some.png" />
            </div>
        </div>
        <div class="tao-man">
            <img src="img/tiger-men.png" />
        </div>
    </div>
